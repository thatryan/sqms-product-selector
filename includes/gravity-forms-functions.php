	...
	if ( $current_page == 10 ) {
		...
		foreach ( $form['fields'] as &$field ) {
		    ...
		    foreach ( $posts as $post ) {
		    	...
		    	$dealer = $post->post_title;
		    	$yelp_id = get_post_meta( $post_id, 'sqms-product-yelp', true );
		    	$phone = get_post_meta( $post_id, 'sqms-product-phone', true );

		    	$address = get_post_meta( $post_id, 'sqms-product-address', 1 );
		    	...
		    	$display = '<span class="product-choice-title">' . $dealer . '</span>';
		    	$display .= $thumb;
		    	$display .= '<h5>' . $phone . '</h5>';
		    	...
		    	$dealers[] = array( 'text' => $display, 'value' => $post_id );
		    }

		    $field->choices = $dealers;
		}
...
function replace_dealer_notification( $text, $form, $entry, $url_encode, $esc_html, $nl2br, $format ) {
    ...
    // $product_data = get_notification_product_data( $prod_string, $product_post_id );

    // GFCommon::log_debug( __METHOD__ . '(): Entry details: ' . print_r( $entry, true ) );
    ...
    $prod_data_output .= '<tr bgcolor="#EAF2FA">';
    $prod_data_output .= '<td colspan="2">';
    $prod_data_output .= '<font style="font-family:sans-serif;font-size:12px"><strong>Address</strong></font>';
    $prod_data_output .= '</td>';
    $prod_data_output .= '</tr>';
    $prod_data_output .= '<tr bgcolor="#FFFFFF">';
    $prod_data_output .= '<td width="20">&nbsp;</td>';
    $prod_data_output .= '<td>';
    $prod_data_output .= '<font style="font-family:sans-serif;font-size:12px">' . $formatted_address_value . '</font>';
    $prod_data_output .= '</td>';
    $prod_data_output .= '</tr>';
    $prod_data_output .= '<tr bgcolor="#EAF2FA">';
    $prod_data_output .= '<td colspan="2">';
    ...
    $prod_data_output .= '<tr bgcolor="#EAF2FA">';
    $prod_data_output .= '<td colspan="2">';
    $prod_data_output .= '<font style="font-family:sans-serif;font-size:12px"><strong>Best Day To Contact</strong></font>';
    $prod_data_output .= '</td>';
    $prod_data_output .= '</tr>';
    $prod_data_output .= '<tr bgcolor="#FFFFFF">';
    $prod_data_output .= '<td width="20">&nbsp;</td>';
    $prod_data_output .= '<td>';
    $prod_data_output .= '<font style="font-family:sans-serif;font-size:12px">' . $contact_string . '</font>';
    $prod_data_output .= '</td>';
    $prod_data_output .= '</tr>';
    $prod_data_output .= '<tr bgcolor="#EAF2FA">';
    $prod_data_output .= '<td colspan="2">';
    $prod_data_output .= '<font style="font-family:sans-serif;font-size:12px"><strong>Best Time For Contact</strong></font>';
    $prod_data_output .= '</td>';
    $prod_data_output .= '</tr>';
    $prod_data_output .= '<tr bgcolor="#FFFFFF">';
    $prod_data_output .= '<td width="20">&nbsp;</td>';
    $prod_data_output .= '<td>';
    $prod_data_output .= '<font style="font-family:sans-serif;font-size:12px">' . rgar( $entry, '50' ) . '</font>';
    $prod_data_output .= '</td>';
    $prod_data_output .= '</tr>';
    $prod_data_output .= '</tbody>';
    $prod_data_output .= '</table>';
    ...
    $prod_data_output .= '<tbody>';
    $prod_data_output .= '<tr>';
    $prod_data_output .= '<td colspan="2" style="font-size:14px;font-weight:bold;background-color:#eee;border-bottom:1px solid #dfdfdf;padding:7px 7px">Customer is Interested in:</td>';
    $prod_data_output .= '</tr>';
    $prod_data_output .= '<tr bgcolor="#EAF2FA">';
    $prod_data_output .= '<td colspan="2">';
    $prod_data_output .= '<font style="font-family:sans-serif;font-size:12px"><strong>Microff Financing</strong></font>';
    $prod_data_output .= '</td>';
    $prod_data_output .= '</tr>';
    $prod_data_output .= '<tr bgcolor="#FFFFFF">';
    $prod_data_output .= '<td width="20">&nbsp;</td>';
    $prod_data_output .= '<td>';
    $prod_data_output .= '<font style="font-family:sans-serif;font-size:12px">' . rgar( $entry, '9' ) . '</font>';
    $prod_data_output .= '</td>';
    $prod_data_output .= '</tr>';
    $prod_data_output .= '<tr bgcolor="#EAF2FA">';
    $prod_data_output .= '<td colspan="2">';
    $prod_data_output .= '<font style="font-family:sans-serif;font-size:12px"><strong>Extended Warranty</strong></font>';
    $prod_data_output .= '</td>';
    $prod_data_output .= '</tr>';
    $prod_data_output .= '<tr bgcolor="#FFFFFF">';
    $prod_data_output .= '<td width="20">&nbsp;</td>';
    $prod_data_output .= '<td>';
    $prod_data_output .= '<font style="font-family:sans-serif;font-size:12px">' . rgar( $entry, '10' ) . '</font>';
    $prod_data_output .= '</td>';
    $prod_data_output .= '</tr>';
    $prod_data_output .= '<tr bgcolor="#EAF2FA">';
    $prod_data_output .= '<td colspan="2">';
    $prod_data_output .= '<font style="font-family:sans-serif;font-size:12px"><strong>Additional Accessories</strong></font>';
    $prod_data_output .= '</td>';
    $prod_data_output .= '</tr>';
    $prod_data_output .= '<tr bgcolor="#FFFFFF">';
    $prod_data_output .= '<td width="20">&nbsp;</td>';
    $prod_data_output .= '<td>';
    $prod_data_output .= '<font style="font-family:sans-serif;font-size:12px">' . $accessory_string . '</font>';
    $prod_data_output .= '</td>';
    $prod_data_output .= '</tr>';
    $prod_data_output .= '</tbody>';
    $prod_data_output .= '</table>';
    ...
    $prod_data_output .= '<tr bgcolor="#FFFFFF">';
    $prod_data_output .= '<td>';
    $prod_data_output .= '<font style="font-family:sans-serif;font-size:12px">AHRI</font>';
    $prod_data_output .= '</td>';
    $prod_data_output .= '<td>';
    $prod_data_output .= '&nbsp;';
    $prod_data_output .= '</td>';
    $prod_data_output .= '<td>';
    $prod_data_output .= '<font style="font-family:sans-serif;font-size:12px">' . get_post_meta( $product_post_id, 'sqms-product-ahri', true ) . '</font>';
    $prod_data_output .= '</td>';
    $prod_data_output .= '</tr>';
    $prod_data_output .= '</tbody>';
    $prod_data_output .= '</table>';
...
function get_notification_product_data( $entry, $prod_string, $product_post_id ) {
	...
	$prod_data_output .= '<td width="20">&nbsp;</td>';
	$prod_data_output .= '<td>';
	$prod_data_output .= '<font style="font-family:sans-serif;font-size:12px">' . rgar( $entry, '11.2' ) . '</font>';
	$prod_data_output .= '</td>';
	$prod_data_output .= '</tr>';
	$prod_data_output .= '<tr bgcolor="#EAF2FA">';
	$prod_data_output .= '<td colspan="2">';
	...
	$prod_data_output .= '<td width="20">&nbsp;</td>';
	$prod_data_output .= '<td>';
	$prod_data_output .= '<font style="font-family:sans-serif;font-size:12px">' . rgar( $entry, '47.1' ) . '</font>';
	$prod_data_output .= '</td>';
	$prod_data_output .= '</tr>';
	$prod_data_output .= '<tr bgcolor="#EAF2FA">';
	$prod_data_output .= '<td colspan="2">';
	...
	$prod_data_output .= '<td width="20">&nbsp;</td>';
	$prod_data_output .= '<td>';
	$prod_data_output .= '<font style="font-family:sans-serif;font-size:12px">' . rgar( $entry, '49' ) . '</font>';
	$prod_data_output .= '</td>';
	$prod_data_output .= '</tr>';
	$prod_data_output .= '<tr bgcolor="#EAF2FA">';
	$prod_data_output .= '<td colspan="2">';
	...
	$prod_data_output .= '<td width="20">&nbsp;</td>';
	$prod_data_output .= '<td>';
	$prod_data_output .= '<font style="font-family:sans-serif;font-size:12px">' . rgar( $entry, '57' ) . '</font>';
	$prod_data_output .= '</td>';
	$prod_data_output .= '</tr>';
	$prod_data_output .= '</tbody>';
	$prod_data_output .= '</table>';
	...
	$prod_data_output .= '<tbody>';
	$prod_data_output .= '<tr>';
	$prod_data_output .= '<td colspan="2" style="font-size:14px;font-weight:bold;background-color:#eee;border-bottom:1px solid #dfdfdf;padding:7px 7px">Quote Details:</td>';
	$prod_data_output .= '</tr>';
	$prod_data_output .= '<tr bgcolor="#EAF2FA">';
	$prod_data_output .= '<td>';
	$prod_data_output .= '<font style="font-family:sans-serif;font-size:12px">Selection</font>';
	...
	$prod_data_output .= '<tbody>';
	$prod_data_output .= '<tr>';
	$prod_data_output .= '<td colspan="2" style="font-size:14px;font-weight:bold;background-color:#eee;border-bottom:1px solid #dfdfdf;padding:7px 7px">Performance Data:</td>';
	$prod_data_output .= '</tr>';
	$prod_data_output .= '<tr bgcolor="#EAF2FA">';
	$prod_data_output .= '<td>';
	$prod_data_output .= '<font style="font-family:sans-serif;font-size:12px">Cooling BTU</font>';
	...
	$prod_data_output .= '<tbody>';
	$prod_data_output .= '<tr>';
	$prod_data_output .= '<td colspan="2" style="font-size:14px;font-weight:bold;background-color:#eee;border-bottom:1px solid #dfdfdf;padding:7px 7px">Application Data:</td>';
	$prod_data_output .= '</tr>';
	$prod_data_output .= '<tr bgcolor="#EAF2FA">';
	$prod_data_output .= '<td>';
	$prod_data_output .= '<font style="font-family:sans-serif;font-size:12px">Application</font>';
